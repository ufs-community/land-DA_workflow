...
# get OUTDIR
source ./settings_cycle_test_release
...
cmp ${OUTDIR}/modl/restarts/vector/ufs_land_restart_${state}.${TEST_DATE}.nc ${TEST_BASEDIR}/ufs_land_restart_${state}.${TEST_DATE}.nc
